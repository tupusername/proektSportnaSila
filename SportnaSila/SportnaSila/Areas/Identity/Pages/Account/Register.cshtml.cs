...
namespace SportnaSila.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private Clients CreateUser()
        {
            try
            {
                return Activator.CreateInstance<Clients>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(Clients)}'. " +
                    $"Ensure that '{nameof(Clients)}' is not an abstract class and has a parameterless constructor, or alternatively " +
